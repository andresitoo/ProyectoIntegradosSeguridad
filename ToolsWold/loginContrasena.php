...
<div class="container_12">
  ...
  <div class="grid_12">
    ...
    <div  class="estilo1"><a href="loginUsuario.php"><img src="images/tools.png" alt=""/></a> Tools World 
    </div>
  ...
  <hr  />
    ...
    <br />
    <br />
    <img src="images/pass.png" class="imagen1" alt=""/>
    <br />
    <br />
    <form name="ingreso" action="pages/objetos/validarPass.php" method="post">
      <br />
    ...
    <br />
         <p id="login-form-username">
          <label for="modlgn_username" class="estilo2">Contraseña: </label>
          <input id="pass" type="text" name="pass" class="inputbox" size="18" autocomplete="off" />
        </p>
        <br />
